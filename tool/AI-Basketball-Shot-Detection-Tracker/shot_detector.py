...
class ShotDetector:
    def __init__(self, video_path=None, use_webcam=False):
        ...
        if use_webcam:
            # Use webcam (stream from iPhone using Iriun Webcam or built-in camera)
            ...
            if os.path.exists(default_video):
                ...
                print("Usage: python shot_detector.py [video_path] or python shot_detector.py --webcam")
                sys.exit(1)
...
if __name__ == "__main__":
    ...
    ShotDetector(video_path=video_path, use_webcam=use_webcam)
